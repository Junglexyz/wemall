...
public class NotifyService {
    ...
    */
    ...
    public String sendCheckSuccessMessage(Map<String, String> params){
        ...
        data.put("character_string6", new TemplateData(params.get("orderId")));
        data.put("amount3", new TemplateData(params.get("payMoney")));
        data.put("thing1", new TemplateData(params.get("orderType")));
        data.put("thing5", new TemplateData("双安文承维生活超市online"));
        data.put("thing9", new TemplateData(params.get("tip")));
        String page = "";
    ...
    public String sendDeliveryMessage(String touser, String orderId, String packupCode, String deliveryWay){
        Map<String, TemplateData> data = new HashMap<>(8);
        data.put("character_string8", new TemplateData(packupCode));
        data.put("character_string7", new TemplateData(orderId));
        data.put("phone_number5", new TemplateData("18789197915"));
        data.put("thing3", new TemplateData("双安镇街道双安文承维生活超市"));
        data.put("thing4", new TemplateData("1".equals(deliveryWay) ? "即将配送请注意查收" : "凭提货单号取货"));
        String page = "";
