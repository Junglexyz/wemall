<template>
	<div class="container">
	    ...
	    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
	      <el-form :model="coupon" ref="coupon" label-width="100px">
	      	<el-form-item>
	        ...
	        <el-form-item label="满足金额">
	          <el-input v-model="coupon.targetMoney"></el-input>
	        </el-form-item>
	        <el-form-item label="优惠金额" prop="discountMoney">
	          <el-input v-model="coupon.discountMoney"></el-input>
	        </el-form-item>
		...
		methods: {
			...
			handleDelete(row){
				this.$confirm('确认删除此商品?', '删除商品', {
		          ...
		          let query = {couponId: row.couponId}
		          console.log(query)
